...
<head>
  ...
  <!-- Toastr core CSS -->
  <link href="{{ asset('public/FrontEnd/toastr/toastr.min.css') }}" rel="stylesheet">

  <!-- Custom fonts for this template -->
  <link href="{{ asset('public/FrontEnd/vendor/fontawesome-free/css/all.min.csss') }}" rel="stylesheet" type="text/css">
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="{{url('/')}}">First Blog</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ Route('writepost') }}">Write Post</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ Route('contact') }}">Contact</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ Route('create') }}">Student</a>
          </li>
        </ul>
      </div>
    </div>
